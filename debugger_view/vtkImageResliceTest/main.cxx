...
int main(int argc, char* argv[])
{
    ...
    readerDcm->SetDirectoryName("D:/test_data/202110020082000");
    readerDcm->Update();
...
#else
    auto imageData = readerDcm->GetOutput();
    center[0] = imageData->GetOrigin()[0] + (double)((imageData->GetExtent()[0] + imageData->GetExtent()[1]) / 2) * imageData->GetSpacing()[0];
    center[1] = imageData->GetOrigin()[1] + (double)((imageData->GetExtent()[2] + imageData->GetExtent()[3]) / 2) * imageData->GetSpacing()[1];
    center[2] = imageData->GetOrigin()[2] + (double)((imageData->GetExtent()[4] + imageData->GetExtent()[5]) / 2) * imageData->GetSpacing()[2];
#endif
#if 1
