    ...
    ::imgui_render_callback = [&]
        {
            ...
            vtkns::vtkObjSetup("Light1", mylight, ImGuiTreeNodeFlags_DefaultOpen);
            vtkns::vtkObjSetup("Light2", mylight1, ImGuiTreeNodeFlags_DefaultOpen);
            vtkns::vtkObjSetup("Cylinder", cylinderactor, ImGuiTreeNodeFlags_DefaultOpen);
        };
